...
def main():
    ...
    # dir
    parser.add_argument('--data_dir', type=str, default='../..', help='dataset dir (default: ./datasets)')
    ...
    parser.add_argument('--classifier', type=str, default='nce', help='classifier name (default: nce)')
    ...
    parser.add_argument('--base_epochs', type=int, default=100, metavar='N', help='base epochs (default:50)')
    parser.add_argument('--new_epochs', type=int, default=60, metavar='N', help='base epochs (default:50)')
    ...
    parser.add_argument('--alpha', type=float, default=0.75, help='loss alpha (default: 0.5)')
